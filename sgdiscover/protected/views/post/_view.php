        ...
        <tbody>
            ...
            <tr>
                ...
                <td rowspan='5'
                            ...
                            class='hideMobile'><a href=<?php echo CHtml::link("", array('view', 'id'=>$data->id)); ?><img class="thumbnail" src="http://127.0.0.1/yii/sgdiscover/images/pic/<?php echo mt_rand(1,65)?>.jpg" alt="" /></a>
                </td>
            </tr>
